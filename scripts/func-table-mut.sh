...
# v0.1 - 2019-05-31: bug regarding very long sequence (>32767 bp) corrected / speed improvments / better alignment method (use of awk instead of diff) / bug regarding tag and fasta header corrected
